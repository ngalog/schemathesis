...
from ...constants import DEFAULT_DEADLINE, USER_AGENT, DataGenerationMethod
...
class BaseRunner:
    ...
    def _run_tests(
        ...
        **kwargs: Any,
        ...
        for endpoint, data_generation_method, test in self.schema.get_all_tests(template, settings, seed):
